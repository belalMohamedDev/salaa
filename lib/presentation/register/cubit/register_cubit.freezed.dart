...
mixin _$RegisterState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(RegisterModel data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(RegisterModel data)? success,
...
abstract class Success<T> implements RegisterState<T> {
  const factory Success(final RegisterModel data) = _$SuccessImpl<T>;
